...
<p align="center">
  <a href="https://github.com/whiterabb17/r3ngine-mcp" target="_blank">
    <img src="https://img.shields.io/badge/r3ngine--mcp-v1.0.3-blue.svg?logo=none" alt="r3ngine MCP v1.0.3" />
  </a>
  &nbsp;
...
🔌&nbsp;&nbsp; **MCP Access**: official [r3ngine-mcp](https://github.com/whiterabb17/r3ngine-mcp) **v1.0.3** server so IDE agents can read recon, run singular tools with validated `tool_args`, propose follow-ups, and verify OSINT staging through `/api/mcp/` — hashed keys, sessions, and an audit chain in Settings. The UI mirrors singular runs from the Subdomains tab (**Run single tool**).
...
2. Install the companion server from this checkout ([repo](https://github.com/whiterabb17/r3ngine-mcp), [v1.0.3](https://github.com/whiterabb17/r3ngine-mcp/releases)):
